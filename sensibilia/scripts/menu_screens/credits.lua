...
menu.credits_screen.buttons = {
	make_button(( { text_size_mult = 0.8, text_pos = vec2(0, -330-config_table.resolution_h/2+100), animated_text_input = { str = "thank you for playing" } } )), 
	...
	make_button(( { text_pos = vec2(0, -330-config_table.resolution_h/2+430+150*5), text_size_mult = 0.55, animated_text_input = { str = "created for" } } )), 
	make_button(( { text_pos = vec2(0, -330-config_table.resolution_h/2+430+150*7-100), text_size_mult = 0.70, animated_text_input = { str = "microsoft imaginecup contest" } } )), 
