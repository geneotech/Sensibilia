...
blood_piece = {
	...
	linear_damping = 25000,
	should_disappear = true,
	acc = vec2.from_degrees(10) * 40000,
}
...
blood_droplets = {
	spread_degrees = 0,
	angular_offset = minmax(0, 0.2),
	particles_per_burst = minmax_u(1, 2),
	type = emission.BURST;
	velocity = minmax(1, 1200),
	angular_velocity = minmax(0, 100),
	
	particle_templates = blood_templates,
	
	size_multiplier = minmax(0.01, 2.5),
	...
	particle_lifetime_ms = minmax(50, 550)
}
